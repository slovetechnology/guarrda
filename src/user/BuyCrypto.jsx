                ...
                <div className="w-11/12 mx-auto lg:w-10/12 py-10">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="text-base text-primary">Coin Name</div>
                        </div>
                        <div className="text-zinc-500"> <FaEllipsisV /> </div>
                    </div>
                    <div className="flex items-center flex-wrap mt-5 gap-4 dark:text-white">
                        <div className="">
                            <div className="p-2 rounded-md bg-white">
                            <QRCode value={`5yu50yu850tj5t9tj09tu0r9tj30g9rg9gjr9gr-g9r9g9g93gk0r9g0r9`} className='h-[9rem] w-auto' />
                            </div>
                        </div>
                        <div className="">
                            <div className="">Wallet balance:</div>
                            <div className="mb-6 mt-2">
                                <div className="font-bold">0BTC</div>
                                <div className="font-semibold text-zinc-400">0.00USD</div>
                            </div>
                            <div className="">Wallet address:</div>
                            <div className="">5yu50yu850tj5t9tj09tu0r9tj30g9rg9gjr9gr-g9r9g9g93gk0r9g0r9</div>
                        </div>
                    </div>
